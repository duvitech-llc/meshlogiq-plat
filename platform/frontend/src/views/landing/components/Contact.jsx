...
const Contact = () => {
  return <section className="section-custom bg-light bg-opacity-30 border-top" id="contact">
      <Container>
        <Row>
            ...
            <div className="p-4">
              ...
              <div className="d-flex gap-3 mb-4">
                ...
                <div>
                  ...
                  <h5 className="my-2">info@meshlogiq.com</h5>
                  <h5 className="mb-0">support@meshlogiq.com</h5>
                </div>
              </div>
              <div className="d-flex gap-3">
                ...
                <div>
                  ...
                  <h5 className="my-1 lh-lg">MeshLogIQ HQ, 500 Innovation Drive, Suite 200, Rochester, NY 14623, USA</h5>
                </div>
              </div>
            </div>
          </Col>
